...
<head>
    ...
    <title>Guitarra Suhr Signature Andre Nieri HH Modern</title>
</head>
...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="thumbnails">
            <img src="https://i.postimg.cc/fRF9L3MC/suhr.png" class="thumb active" onclick="changeImage(this)">


        </div>

        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/fRF9L3MC/suhr.png">
        </div>

        <div class="product-info">
            <h1 class="product-title">Guitarra Suhr Signature Andre Nieri HH Modern</h1>
            ...
            <div class="price-block">
                <span class="price-current">R$ 39.990,00</span>
    ...
    <div class="txt">
        ...
        <p> Corpo: Mogno
            Topo: bordo<br>
            Pescoço: bordo<br>
            Acabamento do pescoço: alto brilho<br>
            Escala: Ébano<br>
            Perfil do pescoço: Mesmo C<br>
            Raio do braço da guitarra: 16"<br>
            Trastes de aço inoxidável Jumbo<br>
            Captador de braço: Suhr SSH+<br>
            Captador de ponte: Suhr SSV<br>
            Interruptor de 3 vias<br>
            Ponte: selas sólidas Gotoh de 2 postes<br>
            Sintonizadores de bloqueio Suhr<br>
            Cor das ferragens: Dourado<br>
            Estojo rígido incluído<br>
            Cor: Preto Alto Brilho<br>
    ...
    <div class="review-section" data-page-id="guitarrasuhr">
    ...
    <script>
        function addToCart() {
            const product = {
                id: "guitarrasuhr",
                name: "Guitarra Suhr Signature Andre Nieri HH Modern",
                price: 39990.00,
                image: "https://i.postimg.cc/fRF9L3MC/suhr.png",
                qty: 1
            };
