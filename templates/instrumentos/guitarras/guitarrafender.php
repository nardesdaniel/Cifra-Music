...
<head>
    ...
    <title>Guitarra Fender Stratocaster Vintera 60s</title>
</head>
...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="thumbnails">
            <img src="https://i.postimg.cc/xCXjbq8b/fender.png" class="thumb active" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/Qx27NG6x/back.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/9Qffjx2q/zoom.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/LsTvZ6w8/hand.webp" class="thumb" onclick="changeImage(this)">

        </div>

        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/xCXjbq8b/fender.png">
        </div>

        <div class="product-info">
            <h1 class="product-title">Guitarra Fender Stratocaster Vintera 60s</h1>
            ...
            <div class="price-block">
                <span class="price-current">R$ 11.718,25</span>
    ...
    <div class="txt">
        ...
        <p>É o instrumento ideal para músicos que buscam a inigualável sonoridade Fender da 'golden era'! Cada
            instrumento reproduz fielmente as características de cada década. Os modelos modificados, apresentam alguns
            'upgrades' projetados para uma melhor sonoridade e um maior conforto na sua execução.
    ...
    <div class="review-section" data-page-id="guitarrafender">
    ...
    <script>
        function addToCart() {
            const product = {
                id: "guitarrafender",
                name: "Guitarra Fender Stratocaster Vintera 60s",
                price: 11718.25,
                image: "https://i.postimg.cc/xCXjbq8b/fender.png",
                qty: 1
            };
