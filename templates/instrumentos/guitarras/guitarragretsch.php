...
<head>
    ...
    <title>Guitarra Gretsch G5422GLH Electromatic</title>
</head>
...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="thumbnails">
            <img src="https://i.postimg.cc/ZqxjyF0R/gret.png" class="thumb active" onclick="changeImage(this)">

        </div>

        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/ZqxjyF0R/gret.png">
        </div>

        <div class="product-info">
            <h1 class="product-title">Guitarra Gretsch G5422GLH Electromatic</h1>
            ...
            <div class="price-block">
                <span class="price-current">R$ 10.999,00</span>
    ...
    <div class="txt">
        ...
        <p>A Electromatic Classic Hollow Body Double-Cut para canhotos G5422GLH com ferragens douradas apresenta um
            corpo de bordo laminado com perímetros de inspiração vintage e arcos refinados, além de um novo reforço de
            bloco de cavalete para ajudar a reduzir o feedback indesejado. O novo design do bloco de cavalete resulta em
            um som com um ataque mais rápido, foco e sustentação aumentada. Juntamente com os novos captadores FT-5E
            FilterTron, a voz desta construção oca tem um enorme impacto, toque clássico, clareza e definição de notas
            aprimoradas.
        </p>
    </div>
    ...
    <div class="review-section" data-page-id="guitarragretsch">
    ...
    <script>
        function addToCart() {
            const product = {
                id: "guitarragretsch",
                name: "Guitarra Gretsch G5422GLH Electromatic",
                price: 10999.00,
                image: "https://i.postimg.cc/ZqxjyF0R/gret.png",
                qty: 1
            };
