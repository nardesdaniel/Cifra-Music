...
<head>
    ...
    <title>Guitarra Cort KX 700 Evertune OPN</title>
</head>
...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="thumbnails">
            <img src="https://i.postimg.cc/wjyftpcQ/cort.png" class="thumb active" onclick="changeImage(this)">
            <img src="https://assets-musitech.fluxocore.com/v1/pro_40542_g.jpg" class="thumb"
                onclick="changeImage(this)">

        </div>

        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/wjyftpcQ/cort.png">
        </div>

        <div class="product-info">
            <h1 class="product-title">Guitarra Cort KX 700 Evertune OPN</h1>
            ...
            <div class="price-block">
                <span class="price-current">R$ 8,757.00</span>
    ...
    <div class="review-section" data-page-id="guitarracort">
    ...
    <script>
        function addToCart() {
            const product = {
                id: "guitarracort",
                name: "Guitarra Cort KX 700 Evertune OPN",
                price: 8757.00,
