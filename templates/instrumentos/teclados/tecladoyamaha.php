...
<body>
  ...
  <div class="gallery" style="justify-content: center; margin-bottom: 200px;">

    <div class="thumbnails">
      <img src="https://i.postimg.cc/G3NbfXrY/Teclado-Yamaha-IMG-principal-removebg-preview.png" class="thumb active"
        onclick="changeImage(this)">
      <img src="https://i.postimg.cc/ZYgJQwZW/Teclado-Yamaha-IMG-roleta-removebg-preview.png" class="thumb"
        onclick="changeImage(this)">
    </div>

    <div class="main-image">
      <img id="mainImg" src="https://i.postimg.cc/G3NbfXrY/Teclado-Yamaha-IMG-principal-removebg-preview.png">
    </div>

    <div class="product-info">
      <h1 class="product-title">Teclado Yamaha Psr-e473 Arranjador Kit Capa Suporte E Pedal</h1>
      ...
      <div class="price-block">
        <span class="price-current">R$ 3.500,00</span>
  ...
  <div class="review-section" data-page-id="teladoyamaha">
  ...
  <script>
    function addToCart() {
      const product = {
        ...
        price: 3500.00,
        image: "https://i.postimg.cc/G3NbfXrY/Teclado-Yamaha-IMG-principal-removebg-preview.png",
        qty: 1
      };
