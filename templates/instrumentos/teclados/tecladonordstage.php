...
<head>
  ...
  <title>Teclado Nord Stage</title>
</head>
...
<body>
  ...
  <div class="gallery" style="justify-content: center; height: 600px;">
    ...
    <div class="thumbnails">
      <img src="https://i.postimg.cc/G3jgM4jq/nord1.png" class="thumb active" onclick="changeImage(this)">
    </div>

    <div class="main-image">
      <img id="mainImg" src="https://i.postimg.cc/G3jgM4jq/nord1.png">
    </div>

    <div class="product-info">
      <h1 class="product-title">Teclado Nord Stage 4 88 HA</h1>
      ...
      <div class="price-block">
        <span class="price-current">R$ 33.500,00</span>
  ...
  <div class="review-section" data-page-id="tecladonordstage">
