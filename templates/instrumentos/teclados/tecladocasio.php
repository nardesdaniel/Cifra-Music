...
<body>
  ...
  <div class="gallery" style="justify-content: center; height: 600px;">
    ...
    <div class="thumbnails">
      <img src="https://i.postimg.cc/nh5Vrv3n/Teclado-Casio.webp" class="thumb active" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/dVXQ3851/Teclado-Casio-2.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/2SJjy40B/Teclado-Casio-3.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/GmN3tkXk/Teclado-Casio-4.webp" class="thumb" onclick="changeImage(this)">

    </div>

    <div class="main-image">
      <img id="mainImg" src="https://i.postimg.cc/nh5Vrv3n/Teclado-Casio.webp">
    </div>

    <div class="product-info">
      <h1 class="product-title">Teclado Casio Casiotone 61 Teclas Ct-s300 + Suporte + Pedal</h1>
      ...
      <div class="price-block">
        <span class="price-current">R$ 1237,72</span>
  ...
  <div class="review-section" data-page-id="tecladocasio">
  ...
  <script>
    function addToCart() {
      const product = {
        id: "tecladocasio",
        name: "Teclado Casio Casiotone 61 Teclas Ct-s300 + Suporte + Pedal",
        price: 1237.72,
        image: "https://i.postimg.cc/nh5Vrv3n/Teclado-Casio.webp",
        qty: 1
      };
