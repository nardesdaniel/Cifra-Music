...
<head>
  ...
  <title>Teclado Sintetizador</title>
</head>
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/CIFRA-MUSIC-MAIN/templates/base.php'; ?>
  ...
  <div class="gallery" style="justify-content: center; height: 600px;">
    ...
    <div class="thumbnails">
      <img src="https://i.postimg.cc/Vs7PHZfW/imagem1.png" class="thumb active" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/B6Y7NyTJ/imagem2.png" class="thumb active" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/mkKXWHpp/imagem3.png" class="thumb active" onclick="changeImage(this)">
    </div>

    <div class="main-image">
      <img id="mainImg" src="https://i.postimg.cc/Vs7PHZfW/imagem1.png">
    </div>

    <div class="product-info">
      <h1 class="product-title">Teclado Sintetizador de Palco Roland V-Stage 76 Teclas</h1>
      ...
      <div class="price-block">
        <span class="price-current">R$ 23.000,00</span>
  ...
  <div class="review-section" data-page-id="teladosintetizador">
