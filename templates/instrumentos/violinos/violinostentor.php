...
<body>
  ...
  <div class="gallery" style="justify-content: center; height: 600px;">
    ...
    <div class="thumbnails">
      <img src="https://i.postimg.cc/x8YKYKK5/violino-stentor.webp" class="thumb active" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/PJhmhmmS/violino-stentor-2.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/KjFnFnPy/violino-stentor-3.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/cCZQZQRW/violino-stentor-4.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/C5YjYjGh/violino-stentor-5.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/3NB2wd1T/violino-stentor-6.webp" class="thumb" onclick="changeImage(this)">
    </div>

    <div class="main-image">
      <img id="mainImg" src="https://i.postimg.cc/x8YKYKK5/violino-stentor.webp">
    </div>

    <div class="product-info">
      <h1 class="product-title">
        Violino Arco Breu <br>
        Cavalete Acústico <br>
        4/4 Madeira Com Estojo
      </h1>
      ...
      <div class="price-block">
        <span class="price-current">R$ 254,99</span>
  ...
  <div class="review-section" data-page-id="violino-stentor">
  ...
  <script>
    function addToCart() {
      const product = {
        id: "violino-stentor",
        name: "Violino Arco Breu Cavalete Acústico 4/4 Madeira Com Estojo",
        price: 254.99,
        image: "https://i.postimg.cc/x8YKYKK5/violino-stentor.webp",
        qty: 1
<<<<<<< HEAD
    };
...
>>>>>>> 2a2cec4 (Reparação do código de cadastro de admin)
