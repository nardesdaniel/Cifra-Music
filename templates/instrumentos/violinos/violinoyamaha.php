<div class="review-section" data-page-id="violino-yamaha">
...
function addToCart() {
    const product = {
        ...
        id: "violino-yamaha",
        name: "Violino Yamaha V5sc 4/4 Com Case Cor Natural",
        price: 4700.00,
        image: "https://i.postimg.cc/W1Nw27Yb/violino-yamaha.webp",
        qty: 1
    };
...
<body>
  ...
  <div class="gallery" style="justify-content: center; height: 600px;">
    ...
    <div class="thumbnails">
      ...
      <img src="https://i.postimg.cc/W1Nw27Yb/violino-yamaha.webp" class="thumb active" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/PqkhpPZR/violino-yamaha-2.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/sXjrmqTd/violino-yamaha-3.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/26kDGM04/violino-yamaha-4.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/sXTRNmLN/violino-yamaha-5.webp" class="thumb" onclick="changeImage(this)">
    </div>

    <div class="main-image">
      <img id="mainImg" src="https://i.postimg.cc/W1Nw27Yb/violino-yamaha.webp">
    </div>

    <div class="product-info">
      <h1 class="product-title">
        Violino Yamaha V5sc <br>
        4/4 Com Case Cor Natural
      </h1>
      <img src="" class="thumb active" onclick="changeImage(this)">
      <img src="" class="thumb" onclick="changeImage(this)">
      <img src="" class="thumb" onclick="changeImage(this)">
    </div>
    ...
    <div class="product-info">
      ...
      <div class="price-block">
        ...
        <span class="price-current">R$ 4.700,00</span>
