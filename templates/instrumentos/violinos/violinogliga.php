...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="thumbnails">
            <img src="https://i.postimg.cc/6QSH0fkY/violino-gliga.webp" class="thumb active"
                onclick="changeImage(this)">
            <img src="https://i.postimg.cc/VNT7RWxh/violino-gliga-2.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/Pqc64MGt/violino-gliga-3.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/9fSxpB3f/violino-gliga-4.webp" class="thumb" onclick="changeImage(this)">
        </div>

        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/6QSH0fkY/violino-gliga.webp" alt="Imagem do produto">
        </div>

        <div class="product-info">
            <h1 class="product-title">
                Violino 4/4 Copy<br>
                Semi Profissional Gliga GVL-100<br>
            </h1>
            ...
            <div class="price-block">
                <span class="price-current">R$ 1.337,78</span>
    ...
    <div class="review-section" data-page-id="violino-gliga">
    ...
    <script>
        function addToCart() {
            const product = {
                id: "violino-gliga",
                name: "Violino 4/4 Copy Semi Profissional Gliga GVL-100",
                price: 1337.78,
                image: "https://i.postimg.cc/6QSH0fkY/violino-gliga.webp",
                qty: 1
            };
