...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/HW0BRVKj/capo.webp">
        </div>

        <div class="product-info">
            <h1 class="product-title">Capotraste de aluminium</h1>
            ...
            <div class="price-block">
                <span class="price-current">R$ 40.25</span>
    ...
    <div class="txt">
        ...
        <h2>Capotraste de aluminium</h2>

        <p style="margin-left: 500px; margin-right: 500px;">Fornece um som mais sofisticado ao seu instrumento. Ideal
            para
            músicos que buscam praticidade e qualidade sonora.</p>
        ...
        <div class="img-descricao">
            <img style="width: 500px; height: 500px; margin-bottom: 20px;"
                src="https://i.postimg.cc/HW0BRVKj/capo.webp">
        </div>
    </div>

    <br>

    <div class="review-section" data-page-id="capotraste">
    ...
    <script>
        function addToCart() {
            const product = {
                ...
                name: "Capotraste",
                price: 40.25,
                image: "https://i.postimg.cc/HW0BRVKj/capo.webp",
                qty: 1
            };
