...
<head>
    ...
    <title>Pedal Volume X Mini Dvp4 Dunlop</title>
</head>
...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="thumbnails">
            <img src="https://i.postimg.cc/cLqv17qG/pedal-dunlop.webp" class="thumb active" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/t4hYs1bK/pedal-dunlop-2.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/nhvCXsZt/pedal-dunlop-3.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/y8FkDJBV/pedal-dunlop-4.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/pLDpm9xT/pedal-dunlop-5.webp" class="thumb" onclick="changeImage(this)">
        </div>

        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/cLqv17qG/pedal-dunlop.webp">
        </div>
        ...
        <div class="product-info">
            ...
            <div class="price-block">
                <span class="price-current">R$ 2.699,90</span>
    ...
    <div class="review-section" data-page-id="pedal-dunlop">
    ...
    <script>
        function addToCart() {
            const product = {
                id: "pedal-dunlop",
                name: "Pedal Volume X Mini Dvp4 Dunlop",
                price: 2699.90,
                image: "https://i.postimg.cc/cLqv17qG/pedal-dunlop.webp",
                qty: 1
            };
