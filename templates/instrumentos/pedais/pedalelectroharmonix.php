...
<head>
    ...
    <title>Pedal Electro Harmonix</title>
</head>
<body>
...
<div class="gallery" style="justify-content: center; height: 600px;">
  ...
  <div class="thumbnails">
    <img src="https://i.postimg.cc/RFkh79sr/pedal-electro-harmonix.webp" class="thumb active" onclick="changeImage(this)">
    <img src="https://i.postimg.cc/Kz6jPFqF/pedal-electro-harmonix-2.webp" class="thumb" onclick="changeImage(this)">
    <img src="https://i.postimg.cc/Kz6jPFqc/pedal-electro-harmonix-3.webp" class="thumb" onclick="changeImage(this)">
    <img src="https://i.postimg.cc/G2WtFr74/pedal-electro-harmonix-4.webp" class="thumb" onclick="changeImage(this)">
    <img src="https://i.postimg.cc/nrqzT5gj/pedal-electro-harmonix-5.webp" class="thumb" onclick="changeImage(this)">
  </div>

  <div class="main-image">
    <img id="mainImg" src="https://i.postimg.cc/RFkh79sr/pedal-electro-harmonix.webp">
  </div>

  <div class="product-info">
    <h1 class="product-title">Pedal De Overdrive Electro Harmonix Crayon - E Cor Branco</h1>
    ...
    <div class="price-block">
      <span class="price-current">R$ 752,00</span>
...
<div class="review-section" data-page-id="pedal-electro-harmonix">
...
function addToCart() {
    const product = {
        id: "pedal-electro-harmonix",
        name: "Pedal De Overdrive Electro Harmonix Crayon - E Cor Branco",
        price: 752.00,
        image: "https://i.postimg.cc/RFkh79sr/pedal-electro-harmonix.webp",
        qty: 1
    };
