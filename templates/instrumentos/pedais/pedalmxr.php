...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="thumbnails">
            <img src="https://i.postimg.cc/FR55v7wY/pedal-mxr.webp" class="thumb active" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/85QQGjxr/pedal-mxr-2.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/W3LLVhxr/pedal-mxr-3.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/76884fj9/pedal-mxr-4.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/QtGGDHvY/pedal-mxr-5.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/XJSSWptP/pedal-mxr-6.webp" class="thumb" onclick="changeImage(this)">
        </div>

        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/FR55v7wY/pedal-mxr.webp">
        </div>

        <div class="product-info">
            <h1 class="product-title">
                Pedal de Guitarra <br>
                Elétrica MXR Carbon <br>
                Copy Analog Delay <br>
                M169 Verde
            </h1>
            ...
            <div class="price-block">
                <span class="price-current">R$ 1.790,00</span>
    ...
    <div class="txt">
        ...
        <p style="margin-left: 500px; margin-right: 500px;">O Teclado Yamaha PSR-E473 Arranjador é uma excelente opção
            para
            músicos iniciantes e intermediários que buscam
            qualidade, versatilidade e recursos profissionais em um instrumento portátil. Equipado com 61 teclas
            sensíveis ao
    ...
    <div class="review-section" data-page-id="pedal-mxr">
    ...
    <script>
        function addToCart() {
            const product = {
                id: "pedal-mxr",
                name: "Pedal de Guitarra Elétrica MXR Carbon Copy Analog Delay M169 Verde",
                price: 1790.00,
                image: "https://i.postimg.cc/FR55v7wY/pedal-mxr.webp",
                qty: 1
            };
