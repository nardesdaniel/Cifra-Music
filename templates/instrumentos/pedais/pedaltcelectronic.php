...
<head>
    ...
    <title>Pedal Tc Electronic Grand Magus</title>
...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="thumbnails">
            <img src="https://i.postimg.cc/R002RHyK/pedal-electro-tc.webp" class="thumb active"
                onclick="changeImage(this)">
            <img src="https://i.postimg.cc/9f8H5pZJ/pedal-electro-tc-2.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/hGyRWrT3/pedal-electro-tc-3.webp" class="thumb" onclick="changeImage(this)">
        </div>

        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/R002RHyK/pedal-electro-tc.webp" style="width: auto;">
        </div>

        <div class="product-info">
            <h1 class="product-title">
                Pedal Tc Electronic <br>
                Grand Magus
            </h1>
            ...
            <div class="price-block">
                <span class="price-current">R$ 360,06</span>
    ...
    <div class="review-section" data-page-id="pedal-tc-electronic">
    ...
    <script>
        function addToCart() {
            const product = {
                id: "pedal-tc-electronic",
                name: "Pedal Tc Electronic Grand Magus",
                price: 360.06,
                image: "https://i.postimg.cc/R002RHyK/pedal-electro-tc.webp",
                qty: 1
            };
