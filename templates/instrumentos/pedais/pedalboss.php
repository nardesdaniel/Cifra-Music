...
<head>
    ...
    <title>Pedal de Efeito Boss Distortion DS-1</title>
</head>
...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="thumbnails">
            <img src="https://i.postimg.cc/k58mfXQd/pedal-boss.webp" class="thumb active" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/V68cTQgw/pedal-boss-2.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/HxgCKDz8/pedal-boss-3.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/3RFHQSfj/pedal-boss-4.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/Hx9C1ZvN/pedal-boss-5.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/D0f3vrRD/pedal-boss-6.webp" class="thumb" onclick="changeImage(this)">
        </div>

        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/k58mfXQd/pedal-boss.webp" alt="Imagem Principal">
        </div>
        ...
        <div class="product-info">
            ...
            <div class="price-block">
                <span class="price-current">R$ 560,28</span>
    ...
    <div class="review-section" data-page-id="pedalboss">
    ...
    <script>
        function addToCart() {
            const product = {
                id: "pedalboss",
                name: "Pedal de efeito Boss Distortion DS-1",
                price: 560.28,
                image: "https://i.postimg.cc/k58mfXQd/pedal-boss.webp",
                qty: 1
            };
