...
<body>
  ...
  <div class="gallery" style="justify-content: center; height: 600px;">
    ...
    <div class="thumbnails">
      <img src="https://i.postimg.cc/rsP3q18V/amplificador-fender.webp" class="thumb active"
        onclick="changeImage(this)">
      <img src="https://i.postimg.cc/gjTQGVYZ/amplificador-fender-2.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/ZY71PS6w/amplificador-fender-3.webp" class="thumb" onclick="changeImage(this)">
    </div>

    <div class="main-image">
      <img id="mainImg" src="https://i.postimg.cc/rsP3q18V/amplificador-fender.webp">
    </div>

    <div class="product-info">
      <h1 class="product-title">
        Combo Fender Amplificador <br>
        De Guitarra Champion <br>
        40 Preto/prata</h1>
      ...
      <div class="price-block">
        <span class="price-current">R$ 2.899,00</span>
        <span class="price-installments">Em até 10x sem juros</span>

        <a class="btn-whatsapp" target="_blank"
          href="https://wa.me/55999999999?text=Olá!%20Estou%20interessado%20no%20Combo%20Fender%20Amplificador%20De%20Guitarra%20Champion%2040.%20Gostaria%20de%20saber%20mais%20detalhes.">
  ...
  <div class="review-section" data-page-id="amplificador-fender-champion-40">
  ...
  <script>
    function addToCart() {
      const product = {
        id: "amplificador-fender-champion-40",
        name: "Combo Fender Amplificador De Guitarra Champion 40 Preto/prata",
        price: 2899.00,
        image: "https://i.postimg.cc/rsP3q18V/amplificador-fender.webp",
        qty: 1
      };
