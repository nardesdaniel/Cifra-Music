...
<head>
  ...
  <title>Amplificador Sheldon</title>
</head>
...
<body>
  ...
  <div class="gallery" style="justify-content: center; height: 600px;">
    ...
    <div class="thumbnails">
      <img src="https://i.postimg.cc/28PcS8fP/amplificador-sheldon.webp" class="thumb active"
        onclick="changeImage(this)">
      <img src="https://i.postimg.cc/8CGZLKcF/amplificador-sheldon-2.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/tgbBFSJW/amplificador-sheldon-3.webp" class="thumb" onclick="changeImage(this)">
    </div>

    <div class="main-image">
      <img id="mainImg" src="https://i.postimg.cc/28PcS8fP/amplificador-sheldon.webp">
    </div>

    <div class="product-info">
      <h1 class="product-title">
        Cubo Amplificador <br>
        Para Baixo Bss150 <br>
        Sheldon Preto 15w
      </h1>
      ...
      <div class="price-block">
        <span class="price-current">R$ 383,47</span>
  ...
  <div class="review-section" data-page-id="amplificador-sheldon">
  ...
  <script>
    function addToCart() {
      const product = {
        id: "amplificador-sheldon",
        name: "Cubo Amplificador Para Baixo Bss150 Sheldon Preto 15w",
        price: 383.47,
        image: "https://i.postimg.cc/28PcS8fP/amplificador-sheldon.webp",
        qty: 1
      };
