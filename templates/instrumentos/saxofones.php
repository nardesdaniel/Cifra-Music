    ...
    <div class="cards-container">
        ...
        <div class="card">
            ...
            <button class="buttonViolao"><a class="aViolao" style="text-decoration: none;"
                    href="{{ url_for('saxofone_modelo', modelo='yamaha') }}">Comprar</a></button>
        </div>
        ...
        <div class="card">
            ...
            <h2 class="precoViolao">R$ </h2>
            <button class="buttonViolao"><a class="aViolao" style="text-decoration: none;"
                    href="{{ url_for('saxofone_modelo', modelo='selmer') }}">Comprar</a></button>
        </div>
        ...
        <div class="card">
            ...
            <h2 class="precoViolao">R$ </h2>
            <button class="buttonViolao"><a class="aViolao" style="text-decoration: none;"
                    href="{{ url_for('saxofone_modelo', modelo='cannonball') }}">Comprar</a></button>
        </div>
        ...
        <div class="card">
            ...
            <h2 class="precoViolao">R$ </h2>
            <button class="buttonViolao"><a class="aViolao" style="text-decoration: none;"
                    href="{{ url_for('saxofone_modelo', modelo='conn') }}">Comprar</a></button>
        </div>
        ...
        <div class="card">
            ...
            <h2 class="precoViolao">R$ </h2>
            <button class="buttonViolao"><a class="aViolao" style="text-decoration: none;"
                    href="{{ url_for('saxofone_modelo', modelo='jupiter') }}">Comprar</a></button>
        </div>
    </div>
</body>
