...
<head>
    ...
    <title>Corda D'Addario XL Nickel ESXL110</title>
</head>
...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="thumbnails">
            <img src="https://i.postimg.cc/pdm00kdH/corda-daddrio-2-removebg-preview-(1).png" class="thumb active"
                onclick="changeImage(this)">
            <img src="https://i.postimg.cc/13CCcbsn/corda-daddrio-removebg-preview.png" class="thumb"
                onclick="changeImage(this)">
            <img src="https://i.postimg.cc/FHWWgwNW/corda-daddrio-3-removebg-preview.png" class="thumb"
                onclick="changeImage(this)">
            <img src="https://i.postimg.cc/g01g1Rwz/corda-daddrio-4-removebg-preview-(1).png" class="thumb"
                onclick="changeImage(this)">

        </div>

        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/pdm00kdH/corda-daddrio-2-removebg-preview-(1).png">
        </div>

        <div class="product-info">
            <h1 class="product-title">Encordoamento Para Guitarra 10-46 D'Addario XL Nickel ESXL110</h1>
    ...
    <div class="txt">
        ...
        <p>As D'Addario XL Nickel Wound são reconhecidas mundialmente como a escolha dos grandes músicos de todos os
            gêneros e
            estilos. <br>
            São feitas de aço banhado a níquel e enroladas com alta precisão ao redor de uma alma hexagonal, <br>
            resultando em uma corda com inconfundível timbre brilhante e excelente afinação.</p>
    </div>

    <br>

    <div class="review-section" data-page-id="cordadaddario">
    ...
    <script>
        function addToCart() {
            const product = {
                id: "esxl110",
                name: "Encordoamento Para Guitarra 10-46 D'Addario XL Nickel ESXL110",
                price: 332.99,
                image: "https://i.postimg.cc/pdm00kdH/corda-daddrio-2-removebg-preview-(1).png",
                qty: 1
            };
