...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="thumbnails">
            <img src="https://i.postimg.cc/L86WgwJ5/corda-solex.webp" class="thumb active" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/4xN0HqYs/corda-solex-2.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/CxL2nXRV/corda-solex-3.webp" class="thumb" onclick="changeImage(this)">

        </div>

        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/L86WgwJ5/corda-solex.webp">
        </div>

        <div class="product-info">
            <h1 class="product-title">Encordoamento Solez Guitarra 010 046 Slg10 Ga 2 Cordas Extra</h1>
            ...
            <div class="price-block">
                <span class="price-current">R$ 43,96</span>
    ...
    <div class="review-section" data-page-id="cordasolez">
    ...
    <script>
        function addToCart() {
            const product = {
                id: "cordasolez",
                name: "Encordoamento Solez Guitarra 010 046 Slg10 Ga 2 Cordas Extra",
                price: 43.96,
                image: "https://i.postimg.cc/L86WgwJ5/corda-solex.webp",
                qty: 1
            };
