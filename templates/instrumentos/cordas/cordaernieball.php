...
<body>
    ...
    <div class="gallery" style="justify-content: center; height: 600px;">
        ...
        <div class="thumbnails">
            <img src="https://i.postimg.cc/yYJMLwVR/Corda-Ernie-Ball.webp" class="thumb active"
                onclick="changeImage(this)">
            <img src="https://i.postimg.cc/hPJk2HSy/Corda-Ernie-Ball-2.webp" class="thumb" onclick="changeImage(this)">
            <img src="https://i.postimg.cc/xdF7GRwT/Corda-Ernie-Ball-3-1.jpg" class="thumb" onclick="changeImage(this)">

        </div>

        <div class="main-image">
            <img id="mainImg" src="https://i.postimg.cc/yYJMLwVR/Corda-Ernie-Ball.webp">
        </div>

        <div class="product-info">
            <h1 class="product-title">Ernie Ball Enc. 045-100 P/ Baixo 4 Cordas Super Slinky Niquel P02834</h1>
            ...
            <div class="price-block">
                <span class="price-current">R$ 183,95</span>
    ...
    <div class="review-section" data-page-id="cordaernieball">
    ...
    <script>
        function addToCart() {
            const product = {
                id: "cordaennieball",
                name: "Ernie Ball Enc. 045-100 P/ Baixo 4 Cordas Super Slinky Niquel P02834",
                price: 183.95,
                image: "https://i.postimg.cc/yYJMLwVR/Corda-Ernie-Ball.webp",
                qty: 1
            };
