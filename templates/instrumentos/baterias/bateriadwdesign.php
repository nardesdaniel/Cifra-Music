...
<head>
  ...
  <title>Bateria Dw Design 5 Peças</title>
</head>
...
<body>
  ...
  <div class="gallery" style="justify-content: center; height: 600px;">
    ...
    <div class="thumbnails">
      <img src="https://i.postimg.cc/HnBhY7pM/Bateria-Dw.webp" class="thumb active" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/yxvb1SVr/Bateria-Dw-2.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/L4T7BGz4/Bateria-Dw-3.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/QNbPkvpF/Bateria-Dw-4.webp" class="thumb" onclick="changeImage(this)">

    </div>

    <div class="main-image">
      <img id="mainImg" src="https://i.postimg.cc/HnBhY7pM/Bateria-Dw.webp">
    </div>

    <div class="product-info">
      <h1 class="product-title">Bateria Dw Design 5 Peças</h1>
      ...
      <div class="price-block">
        <span class="price-current">R$ 25.000,00</span>
  ...
  <div class="txt">
    ...
    <p>As D'Addario XL Nickel Wound são reconhecidas mundialmente como a escolha dos grandes músicos de todos os gêneros
      e estilos. <br>
  ...
  <div class="review-section" data-page-id="bateriadw">
  ...
  <script>
    function addToCart() {
      const product = {
        id: "bateriadw_design",
        name: "Bateria Dw Design 5 Peças",
        price: 25000.00,
        image: "https://i.postimg.cc/HnBhY7pM/Bateria-Dw.webp",
        qty: 1
      };
