...
<head>
  ...
  <title>Bateria Eletrônica Zildjian</title>
</head>
...
<body>
  ...
  <div class="gallery" style="justify-content: center; height: 600px;">
    ...
    <div class="thumbnails">
      <img src="https://i.postimg.cc/Pr1yhR4r/Bateria-Eletronica-Zildjian.webp" class="thumb active"
        onclick="changeImage(this)">
      <img src="https://i.postimg.cc/bN1g8BTG/Bateria-Eletronica-Zildjian-2.webp" class="thumb"
        onclick="changeImage(this)">
      <img src="https://i.postimg.cc/wjHVBQf6/Bateria-Eletronica-Zildjian-3.webp" class="thumb"
        onclick="changeImage(this)">
      <img src="https://i.postimg.cc/x1YRd3xC/Bateria-Eletronica-Zildjian-4.webp" class="thumb"
        onclick="changeImage(this)">

    </div>

    <div class="main-image">
      <img id="mainImg" src="https://i.postimg.cc/Pr1yhR4r/Bateria-Eletronica-Zildjian.webp">
    </div>

    <div class="product-info">
      <h1 class="product-title">Bateria Eletrônica Zildjian Alchem-E</h1>
      ...
      <div class="price-block">
        <span class="price-current">R$ 80.642,57</span>
  ...
  <div class="txt">
    ...
    <h3>Bateria Eletrônica Zildjian Alchem-E</h3>
    <p>A Bateria Eletrônica Zildjian Alchem-E é uma excelente escolha para músicos que buscam qualidade e versatilidade.
      <br>
  ...
  <div class="review-section" data-page-id="bateriaeletronicazildjian">
  ...
  <script>
    function addToCart() {
      const product = {
        id: "bateriaeletronicazildjian",
        name: "Bateria Eletrônica Zildjian Alchem-E",
        price: 80642.57,
        image: "https://i.postimg.cc/Pr1yhR4r/Bateria-Eletronica-Zildjian.webp",
        qty: 1
      };
