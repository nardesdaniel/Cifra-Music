...
<head>
  ...
  <title>Bateria Pearl Master</title>
</head>
...
<body>
  ...
  <div class="gallery" style="justify-content: center; height: 600px;">
    ...
    <div class="thumbnails">
      <img src="https://i.postimg.cc/nL4TVQ2H/Bateria-Pearl-Master.webp" class="thumb active"
        onclick="changeImage(this)">
      <img src="https://i.postimg.cc/XvfxNyLv/Bateria-Pearl-Master-2.webp" class="thumb" onclick="changeImage(this)">
      <img src="https://i.postimg.cc/25QTjBGq/Bateria-Pearl-Master-3.webp" class="thumb" onclick="changeImage(this)">
    </div>

    <div class="main-image">
      <img id="mainImg" src="https://i.postimg.cc/nL4TVQ2H/Bateria-Pearl-Master.webp">
    </div>

    <div class="product-info">
      <h1 class="product-title">Bateria Pearl Master</h1>
      ...
      <div class="price-block">
        <span class="price-current">R$ 50.000,00</span>
  ...
  <div class="review-section" data-page-id="bateriapearlmaster">
  ...
  <script>
    function addToCart() {
      const product = {
        id: "bateriapearl_master",
        name: "Bateria Pearl Master",
        price: 50000.00,
        image: "https://i.postimg.cc/nL4TVQ2H/Bateria-Pearl-Master.webp",
        qty: 1
      };
