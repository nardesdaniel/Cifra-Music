...
<head>
  ...
  <title>Bateria Eletrônica Roland</title>
</head>
...
<body>
  ...
  <div class="gallery" style="justify-content: center; height: 600px;">
    ...
    <div class="thumbnails">
      <img src="https://i.postimg.cc/BnGhK06S/Bateria-Eletronica-Roland.webp" class="thumb active"
        onclick="changeImage(this)">
      <img src="https://i.postimg.cc/7ZyB2k6b/Bateria-Eletronica-Roland-2.webp" class="thumb"
        onclick="changeImage(this)">
      <img src="https://i.postimg.cc/2SfHZD6h/Bateria-Eletronica-Roland-3.webp" class="thumb"
        onclick="changeImage(this)">
      <img src="https://i.postimg.cc/8zBZd0Jh/Bateria-Eletronica-Roland-4.webp" class="thumb"
        onclick="changeImage(this)">

    </div>

    <div class="main-image">
      <img id="mainImg" src="https://i.postimg.cc/BnGhK06S/Bateria-Eletronica-Roland.webp">
    </div>

    <div class="product-info">
      <h1 class="product-title">Roland VAD507 | Bateria Eletrônica</h1>
  ...
  <div class="txt">
    ...
    <h3>Roland VAD507 | Bateria Eletrônica</h3>
    <p>A Bateria Eletrônica Roland VAD507 é uma excelente escolha para músicos que buscam qualidade e versatilidade.
      <br>
  ...
  <div class="review-section" data-page-id="bateriaeletronicaroland">
  ...
  <script>
    function addToCart() {
      const product = {
        id: "bateriaeletronicaroland",
        name: "Roland VAD507 | Bateria Eletrônica",
        price: 50000.00,
        image: "https://i.postimg.cc/BnGhK06S/Bateria-Eletronica-Roland.webp",
        qty: 1
      };
